...
## Environments
- Preview: https://main--adobe-eds-temp--sourabhKhera.aem.page/
- Live: https://main--adobe-eds-temp--sourabhKhera.aem.live/
...
1. Open the `adobe-eds-temp` directory in your favorite IDE and start coding :)
